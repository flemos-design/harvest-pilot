      ...
      <header className="bg-white dark:bg-gray-800 border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Organizações</h1>
              <p className="text-gray-600 dark:text-gray-400 mt-1">Gestão de organizações e propriedades</p>
            </div>
            <Link
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Total Organizações</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Total Propriedades</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalPropriedades}</p>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalUtilizadores}</p>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Média Propriedades</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.avgPropriedadesPorOrganizacao.toFixed(1)}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <main className="container mx-auto px-4 pb-8">
        {!organizacoes || organizacoes.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Nenhuma organização</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">Começa por criar a tua primeira organização</p>
            <Link
              href="/organizacoes/nova"
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">{org.nome}</h3>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                        <code className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">/{org.slug}</code>
                      </div>
                    </div>
                  </div>
