          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full p-6">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Faça upload do ficheiro</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">O sistema extrai automaticamente</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                    Propriedades e terrenos são detetados pela estrutura do ficheiro:
                  </p>
                  <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded p-3 text-sm font-mono">
                    <div className="flex items-center gap-2 text-blue-600">
                      <FolderTree className="w-4 h-4" />
                      <span>Pasta/Folder</span>
                      <span className="text-gray-400">→</span>
                      <span className="text-gray-700 dark:text-gray-300">Propriedade</span>
                    </div>
                    <div className="flex items-center gap-2 text-green-600 ml-6 mt-1">
                      <MapPin className="w-4 h-4" />
                      <span>Marcadores com áreas</span>
                      <span className="text-gray-400">→</span>
                      <span className="text-gray-700 dark:text-gray-300">Terrenos</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Reveja e edite (opcional)</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Importe tudo de uma vez</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleCloseWelcome}
                className="px-6 py-3 bg-gray-200 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300"
              >
      ...
      <header className="bg-white dark:bg-gray-800 border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Importar Terrenos</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Escolha o ficheiro KMZ ou KML exportado</p>
            </div>
          </div>
          ...
          <div className="mt-6 flex gap-3">
            ...
            {propriedades.length > 0 && (
              <button
                ...
                className="px-6 py-2 bg-gray-200 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300"
              >
                Limpar e recomeçar
              </button>
            )}
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200">
                          {prop.terrenos.map((terreno, terrenoIndex) => (
                            <tr key={terrenoIndex} className="hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Criar todas as propriedades e terrenos</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={importMutation.isPending}
                className="px-6 py-3 bg-gray-200 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 disabled:opacity-50"
              >
                Cancelar
              </button>
            </div>
