      ...
      <header className="bg-white dark:bg-gray-800 border-b">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Novo Utilizador</h1>
              <p className="text-gray-600 dark:text-gray-400 mt-1">Adicionar novo utilizador ao sistema</p>
            </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6 space-y-6">
            <div className="flex items-center gap-3 pb-4 border-b">
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Informações do Utilizador</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">Preenche os dados básicos</p>
              </div>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Papel *</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Organização *</label>
              {loadingOrgs ? (
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Link href="/utilizadores" className="px-6 py-3 bg-gray-200 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 transition inline-flex items-center justify-center gap-2 font-medium">
                Cancelar
              </Link>
            </div>
          </div>
