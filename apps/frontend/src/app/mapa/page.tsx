      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2 bg-white dark:bg-gray-800 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 transition inline-flex items-center gap-2 text-sm font-medium"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Total de Terrenos</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Área Média</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Com Geometria</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            <Map height="calc(100vh - 320px)" showControls={true} centerOnParcelas={true} parcelas={parcelas} />
          </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Terrenos</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Áreas cultivadas</p>
                    </div>
                  </div>
                </div>

                <div className="mt-6 pt-6 border-t">
                  <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3">Interação</h4>
                  ...
                  {parcelas && parcelas.length > 0 ? (
                    parcelas.map(parcela => (
                      <Link
                        ...
                        className="block p-3 bg-gray-50 dark:bg-gray-900 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-700 transition"
                      >
                        <p className="font-medium text-gray-900 dark:text-gray-100 text-sm">{parcela.nome}</p>
                        <div className="flex items-center justify-between mt-1">
                          <p className="text-xs text-gray-600 dark:text-gray-400">{parcela.area} ha</p>
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500 dark:text-gray-400 text-sm">Sem terrenos registados</p>
                      <Link
                        href="/parcelas/nova"
